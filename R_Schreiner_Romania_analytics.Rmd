...
# no intercorrelation available only field size + ratio
```
...
add the temp close to the samplers
```{r}
...
since number of detected compounds only comprise discrete values, use of glm with poinsson distribution
```{r}
